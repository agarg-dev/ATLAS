...
3. [CSV evaluation pipeline (generic datasets)](#csv-evaluation-pipeline-generic-datasets)
4. [Alternative CodeGen loaders](#alternative-codegen-loaders)
5. [Analysis utilities](#analysis-utilities)
6. [Debug utilities](#debug-utilities)
7. [Relation to the rest of the repo](#relation-to-the-rest-of-the-repo)
...
Reports line-level and Python function-level Hit@K and MRR across all
validation folds.
